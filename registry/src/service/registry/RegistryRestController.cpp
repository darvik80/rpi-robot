...
#include "RegistryRestController.h"
...
void RegistryRestController::handle(const HttpRequest &request, HttpResponse &response) {
...
void RegistryRestController::handleGet(const HttpRequest &request, const HttpParams &params, HttpResponse &response) {
