...
IotRegistry RegistryRepository::findById(long regId) {
...
std::optional<IotRegistry> RegistryRepository::findByName(std::string_view name) {
    pqxx::nontransaction w(_source.getConnection());
...
std::list<IotRegistry> RegistryRepository:: findAll(std::string_view name, long offset, int limit) {
    pqxx::nontransaction w(_source.getConnection());
...
long RegistryRepository::insert(const IotRegistry &registry) {
...
void RegistryRepository::update(const IotRegistry &registry) {
    pqxx::work worker(_source.getConnection());
