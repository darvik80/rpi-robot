...
DataSource::DataSource(std::string_view host, int port, std::string_view username, std::string_view password,
                       std::string_view database) {
    _connString = fmt::format("user={} host={} port={} password={} dbname={}", username, host, port, password,
                              database);
